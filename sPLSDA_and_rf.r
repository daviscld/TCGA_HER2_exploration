...
#Generate outputs for CIBERSORT
#Download LM22 signature matrix from CIBERSORT website and read in gene list
lm22 <- read.table("LM22.txt", sep = "\t", header = TRUE)
lm22_genes <- lm22$Gene.symbol

# Filter VST matrix to LM22 genes only to reduce file size for CIBERSORT input
